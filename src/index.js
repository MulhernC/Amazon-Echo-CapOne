 ...
 */
var APP_ID =  "amzn1.ask.skill.eb34c0d7-4850-4939-ae8a-b515d8b80bc8"; //replace with "amzn1.echo-sdk-ams.app.[your-unique-value-here]";
...
//BalanceEnquiryIntent returns account balance
//Utterances:
//BalanceEnquiryIntent balance
//BalanceEnquiryIntent {check_syn} my {balance_syn}
//BalanceEnquiryIntent what is my account {balance_syn} 
//BalanceEnquiryIntent {check_syn} {balance_syn} 
//BalanceEnquiryIntent {check_syn} {balance_syn} in my account
//BalanceEnquiryIntent how much {balance_syn} is in my account 

  "BalanceEnquiryIntent": function (intent, session, response) {
    getAccounts(myId, function(callbackObj){
    var getbalance = callbackObj.balance

    dollars1 = Math.floor(getbalance);
    cents1 = Math.floor(100 * (getbalance - Math.floor(getbalance)));
    response.tell("Your balance is " + formatMoney(dollars1, cents1));
    return;
    });
  },
